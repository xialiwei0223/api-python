...
class TestTemporal(unittest.TestCase):
    ...
    def test_get_leap(self):
        ...
        self.assertEqual(vc.to_date(), date(1904, 2, 29))
    ...
    def test_get_datetime(self):
        ...
        self.assertEqual(vc.to_datetime(), datetime(2018, 3, 14, 11, 28, 4))

    def test_upload_datetime(self):
        vdt = datetime(2018, 3, 14, 11, 28, 4)
    ...
    def test_get_month(self):
        vc = xx.run('2018.03M')
        self.assertEqual(vc.to_date(), date(2018, 3, 1))
